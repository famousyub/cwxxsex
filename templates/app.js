angular.module('wd-students', ['ngResource', 'ngRoute'])
    ...
    .factory('StudentService', ['$resource', function ($resource) {
        return $resource('http://127.0.0.1:9876/api/student/:id', {id: '@id'});
    }])
    .factory('TeacherService', ['$resource', function ($resource) {
        return $resource('http://127.0.0.1:9876/api/teacher/:id', {id: '@id'});
    }])
    .factory('BuildingService', ['$resource', function ($resource) {
        return $resource('http://127.0.0.1:9876/api/building/:id', {id: '@id'});
    }])
    .factory('RoomService', ['$resource', function ($resource) {
        return $resource('http://127.0.0.1:9876/api/room/:id', {id: '@id'});
    }])
    .factory('ProgramService', ['$resource', function ($resource) {
        return $resource('http://127.0.0.1:9876/api/program/:id', {id: '@id'});
    }])
    .factory('CourseService', ['$resource', function ($resource) {
        return $resource('http://127.0.0.1:9876/api/course/:id', {id: '@id'});
    }])
    .factory('TimeTableItemService', ['$resource', function ($resource) {
        return $resource('http://127.0.0.1:9876/api/timetable/item/:id', {id: '@id'});
    }])
    .factory('TimeTableLocationService', ['$resource', function ($resource) {
        return $resource('http://127.0.0.1:9876/api/timetable/location/:id', {id: '@id'});
    }])
